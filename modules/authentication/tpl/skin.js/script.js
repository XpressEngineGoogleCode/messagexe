...
function completeUpdate(ret_obj)
{
	...
	{
		jQuery("#authcode_box_3").html('');
		jQuery("#authcode_box_3").append('<div><span>전송완료. 만약 메시지가 도착하지 않으셨다면 스팸함을 확인해주세요.</span></div>');
	}
	...
	else if(r_status == 2 && r_code != 0)
	{
		...
		{
			case 10:
			jQuery("#authcode_box_3").html('잘못된 번호입니다. 번호를 확인해주세요.');
			break;

			case 11:
			jQuery("#authcode_box_3").html('상위 서비스망이 스팸 인식됬습니다.');
			break;

			case 12:
			jQuery("#authcode_box_3").html('이통사 전송불가 입니다.');
			break;

			case 13:
			jQuery("#authcode_box_3").html('필드값이 누락 되었습니다.');
			break;

			case 20:
			jQuery("#authcode_box_3").html('등록된 계정이 아니거나 패스워드가 틀립니다.');
			break;

			case 21:
			jQuery("#authcode_box_3").html('존재하지 않는 메시지 입니다.');
			break;

			case 30:
			jQuery("#authcode_box_3").html('가능한 전송 잔량이 없습니다.');
			break;

			case 40:
			jQuery("#authcode_box_3").html('전송시간 초과입니다.');
			break;
			...
			case 42:
			jQuery("#authcode_box_3").html('음영지역 입니다.');
			break;

			case 43:
			jQuery("#authcode_box_3").html('단말기 파워 오프 입니다.');
			break;

			case 44:
			jQuery("#authcode_box_3").html('단말기 메시지 저장갯수 초과 입니다.');
			break;

			case 45:
			jQuery("#authcode_box_3").html('단말기 일시 서비스 정지 입니다.');
			break;

			case 46:
			jQuery("#authcode_box_3").html('기타 단말기 문제 입니다.');
			break;

			case 47:
			jQuery("#authcode_box_3").html('착신 거절 입니다.');
			break;
			...
			case 50:
			jQuery("#authcode_box_3").html('sms서비스 불가 단말기 입니다.');
			break;

			case 51:
			jQuery("#authcode_box_3").html('착신측의 호불가 상태 입니다.');
			break;
			
			case 52:
			jQuery("#authcode_box_3").html('이통사 서버 운영자 삭제 입니다.');
			break;
			...
			case 54:
			jQuery("#authcode_box_3").html('스팸인식입니다.');
			break;

			case 55:
			jQuery("#authcode_box_3").html('스팸, nospam.or.kr에 등록된 번호 입니다.');
			break;

			case 56:
			jQuery("#authcode_box_3").html('전송실패(무선망단) 입니다.');
			break;

			case 57:
			jQuery("#authcode_box_3").html('전송실패(무선망->단말기단) 입니다.');
			break;

			case 58:
			jQuery("#authcode_box_3").html('전송경로가 없습니다.');
			break;

			case 60:
			jQuery("#authcode_box_3").html('취소하셨습니다.');
			break;

			case 70:
			jQuery("#authcode_box_3").html('허용되지 않은 IP주소 입니다.');
			break;

			case 99:
			jQuery("#authcode_box_3").html('대기상태입니다.');
			break;
		}
