...
class AuthenticationAddon {
    ...
    function AuthenticationAddon($addon_info) {
    ...
    function sendValCode($args) {
        ...
        // delete
        $query_id = 'authentication.deleteValCode';
        unset($args);
        $args = new StdClass();
        ...
        // insert
        $query_id = 'authentication.insertValCode';
        unset($args);
        $args = new StdClass();
        $args->callno = $phonenumber;
        $args->country = $country;
        ...
        $controller = &getController('authentication');
    ...
    function validateValCode($args) {
        ...
        $oAuthenticationModel = &getModel('authentication');
        $output = $oAuthenticationModel->getValCode($args->callno, $args->country);
    ...
    function getValCode($callno, $country) {
        $oAuthenticationModel = &getModel('authentication');
        $output = $oAuthenticationModel->getValCode($callno, $country);
        return $output;
    }
}
?>
